    ...
    >
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Social">
          <div className="flex flex-col space-y-4 text-sm">
            <HoveredLink
              href="https://github.com/kuunal26"
            ...
            <HoveredLink
              href="https://www.linkedin.com/in/kunal-dhanawade-929800228/"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <HoveredLink
              href="https://twitter.com/kuunal26"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <HoveredLink
              href="https://kunaldhanawade.netlify.app/"
              rel="noopener noreferrer"
              target="_blank"
            >
